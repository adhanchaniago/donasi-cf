...
<head>
    ...
    <title>LAZNas Chevron Rumbai - Crowdfunding</title>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a class="logo" href="../index.html"><img src="<?= base_url()?>assets/images/foto/logolazchev.png" alt="logo"></a>
                </div>
                <!-- Logo -->
            ...
            <ul class="navbar-menu nav navbar-nav navbar-right">
                ...
                <li><a href="<?= base_url()?>kampanye">Kampanye</a></li>

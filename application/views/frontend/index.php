<?php include "header.php"?>
		...
		<div id="home-owl" class="owl-carousel owl-theme">
			...
			<div class="home-item">
				<!-- section background -->
				<div class="section-bg" style="background-image: url(<?= base_url()?>assets/images/foto/hanyainiloh.jpg); "></div>
				<!-- /section background -->
				<!-- home content -->
				<div class="home">
					<div class="container">
...
<!--									<a href="#" class="primary-button">View Causes</a>-->
			...
			<div class="home-item">
				<!-- Background Image -->
				<div class="section-bg" style="background-image: url(<?= base_url()?>assets/images/foto/murid.jpg); "></div>
				<!-- /Background Image -->
			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="section-title">
						<h2 class="title"> Selamat datang di Platform Crowdfunding LAZNas Chevron Rumbai</h2>
						<p class="sub-title">Ingin berbuat kebaikan? Bersama LAZNas Chevron Rumbai, kamu bisa membuat perubahan untuk kehidupan mereka.</p>
					</div>
...
<!--							<i class="play-icon fa fa-play"></i>-->
							<img width = "570px" height = "350px" src="<?= base_url()?>assets/images/foto/hanyainiloh.jpg" alt="">
						</a>
				</div>
				<!-- /about video -->
			</div>
			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="section-title text-center">
						...
						<p style="font-weight:normal" class="sub-title"> Pilih kampanye yang ingin Anda bantu.</p>
					</div>
				</div>
				<!-- section title -->
                <?php
				...
				<div class="col-md-12">
					<div id="testimonial-owl" class="owl-carousel owl-theme">
						...
						<div class="testimonial">
							...
							<div class="testimonial-quote">
								<blockquote>
									<p>Tetaplah hidup walau kamu tidak berguna</p>
								</blockquote>
							</div>
						</div>
						<!-- /testimonial -->
						...
						<div class="testimonial">
							...
							<div class="testimonial-quote">
								<blockquote>
									<p>Jangan lupa subskreb karna subskreb itu gratiss</p>
								</blockquote>
							</div>
						</div>
						<!-- /testimonial -->

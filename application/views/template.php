...
<head>
	...
	<title>Back-end Crowdfunding LAZChev Rumbai</title>
	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>SI Crowdfunding </span> Laznas Chevron Rumbai</a>
			...
			<li class="parent ">
				...
				<ul <?php
					...
					<li><a <?php if($this->uri->segment(1)=="Kampanye"){echo 'class="active"';}?> href="
							...
							<span class="fa fa-arrow-right">&nbsp;</span> Kampanye
						</a></li>
